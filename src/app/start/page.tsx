  ...
  return (
    <main className="min-h-svh w-full p-8 flex flex-col gap-8">
      <header className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
        <Image
          src="/fnt-erp.svg"
          alt={t('app.page.logoAlt', 'FnT ERP')}
          width={40}
          height={40}
          priority
        />
        <div className="flex-1">
          <h1 className="text-3xl font-semibold tracking-tight">{t('app.page.title', 'FnT ERP')}</h1>
          <p className="text-sm text-muted-foreground">{t('app.page.subtitle', 'Modern ERP platform for operations, sales, customers, and workflows')}</p>
        </div>
      </header>
