...
import { locales as defaultLocales, type Locale } from '@open-mercato/shared/lib/i18n/config'
import { registerModules } from '@open-mercato/shared/lib/modules/registry'
import type { Module } from '@open-mercato/shared/modules/registry'
import { loadI18nModules } from '@/.mercato/generated/modules.i18n.loaders.generated'

const localeRegistry = defaultLocales as string[]
if (!localeRegistry.includes('vi')) {
  localeRegistry.push('vi')
}

type AppLocale = Locale | 'vi'
...
async function loadAppDictionary(locale: AppLocale): Promise<Record<string, unknown>> {
  switch (locale) {
    case 'en':
    ...
    case 'vi':
      return import('../../i18n/vi.json').then((module) => module.default)
    default:
      return import('../../i18n/en.json').then((module) => module.default)
  }
}
